				...
				<div class="col-md-6 column">
					<form action="denglvdo.php" method="post" class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="yzm" class="form-control bg-info" id="inputPassword3" placeholder="请输入验证码(不区分大小写)"/>		<!--name=yzm-->
							</div>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								 <input type="submit" name="sub" value="登录" class="btn btn-success btn-lg"/>&nbsp;&nbsp;&nbsp;&nbsp;
								 <a href="zhuce.php"><input type="button" value="注册" class="btn btn-info btn-lg"/></a>
							</div>
						</div>
					</form>
				</div>
